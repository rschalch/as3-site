package pages
{
	...
	public class ExternasPage extends AbstractPage
	{
		...
		override public function transitionInComplete():void 
		{
			...
			imageLoader.append(new ImageLoader("images/externas/externa1.jpg", { container:pic.image.bmp, alpha:0 } ));
			imageLoader.load();
