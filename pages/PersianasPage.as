package pages
{
	...
	public class PersianasPage extends AbstractPage
	{
		...
		private var currentAmb:String = "persiana1";
		...
		public function PersianasPage()
		{
			...
			//thumbs.piso1.enable();
			linemenu.bsar.line = "sarja";
			linemenu.bpan.line = "panama";
		...
		override public function transitionInComplete():void 
		{
			...
			imageLoader.append(new ImageLoader("images/persianas/persiana1.jpg", { container:pic.image.bmp, alpha:0 } ));
			imageLoader.load();
			
			setLine(indexpage.getXML("panama"));
		}
