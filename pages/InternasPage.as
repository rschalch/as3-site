package pages
{
	...
	public class InternasPage extends AbstractPage
	{
		...
		private var currentAmb:String = "interna1";
		...
		override public function transitionInComplete():void 
		{
			...
			imageLoader.append(new ImageLoader("images/internas/interna1.jpg", { container:pic.image.bmp, alpha:0 } ));
			imageLoader.load();
			
			setLine(indexpage.getXML("tls"));
		}
