package pages
{
	...
	public class SobrePage extends AbstractPage
	{	
		...
		override public function transitionIn():void 
		{
			...
			lapic = new LiquidArea(this, 748, 266, 188.65, 274.15);
			lapic.attach(pic, { scaleMode:ScaleMode.PROPORTIONAL_INSIDE, vAlign:AlignMode.TOP, hAlign:AlignMode.LEFT, maxWidth:260 } );
